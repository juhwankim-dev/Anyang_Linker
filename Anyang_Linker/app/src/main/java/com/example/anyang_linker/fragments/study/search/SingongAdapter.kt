...
class SingongAdapter(studyrooms: ArrayList<StudyRoom>) : RecyclerView.Adapter<SingongAdapter.MyStudyViewHolder>() {
...
/*        Glide.with(holder.itemView)
        ...
        holder.itemView.setOnClickListener {v->
            ...
            goRoom.putExtra("groupUID", studyrooms.get(position).groupUID)
